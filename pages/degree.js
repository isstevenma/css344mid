...
export default function Degree() {
    ...
    />,
    <Collapsible
    contents={[<Course text="ENGL 110" grade="Grade: 100" credits="Credits: 3" key="1"/>,
               <Course text="ENGL 242" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
    text="Literature"
    completed="100% | 6/6"
    cip="0"
    icon={<CheckIcon/>}
...
/>,
    <Collapsible
    contents={[<Course text="Math 104" grade="Grade: 100" credits="Credits: 3" key="1"/>,
               <Course text="Math 105" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
...
/>,
<Collapsible
    contents={[<Course text="LATN 101" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
    text="Elective"
    completed="100% | 3/3"
    cip="0"
    icon={<CheckIcon/>}
...
/>]}
    ...
    let bee = [
        <Collapsible
        contents={[<Collapsible
            contents={[<Course text="CPSC 110" grade="Grade: 100" credits="Credits: 4" key="1"/>,
                       <Course text="CPSC 121" grade="Grade: 100" credits="Credits: 4" key="1"/>]}
        ...
        />,
        <Collapsible
            contents={[<Course text="CPSC 210" grade="Grade: 100" credits="Credits: 4" key="1"/>,
                       <Course text="CPSC 213" grade="Grade: 100" credits="Credits: 4" key="1"/>,
                       <Course text="CPSC 221" grade="Grade: 100" credits="Credits: 4" key="1"/>]}
        ...
        />,
        <Collapsible
            contents={[<Course text="MATH 200" grade="Grade: 100" credits="Credits: 3" key="1"/>,
                       <Course text="MATH 221" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
        ...
        />,
        <Collapsible
            contents={[<Course text="CPSC 319" grade="Grade: 100" credits="Credits: 4" key="1"/>]}
    ...
    let electives = [
        <Collapsible
        contents = {[<Collapsible
            contents={[<Course text="ENGL 227" grade="Grade: 100" credits="Credits: 3" key="1"/>,
                <Course text="CRWR 200" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
        ...
        <Collapsible
            contents={[<Course text="ENGL 112" grade="Grade: 100" credits="Credits: 3" key="1"/>,
                <Course text="CRWR 203" grade="Grade: 100" credits="Credits: 3" key="1"/>,
                <Course text="CRWR 213" grade="Grade: 100" credits="Credits: 3" key="1"/>]}
            text="Electives (Any)"
            completed="100% | 9/7"
            cip="0"
            icon={<CheckIcon/>}
